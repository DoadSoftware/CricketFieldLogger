    ...
    public partial class Page2Frm : Form
    {
        ...
        private void FielderLbl_Move(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked)
            {
                ...
                File.WriteAllText(FieldLoggerConstants.Cricket_Directory + FieldLoggerConstants.Field_Directory + FieldLoggerConstants.Field_Formation2_File,
        ...
        private void Seamer_Six_By_Four_btn_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < FieldLoggerConstants.Number_Of_Fielders; i++)
            {
                ...
                fieldersData.Fielders.Add(new FieldersFormation(fielderId: i + 1, leftLocation: FielderLbl[i].Left, topLocation: FielderLbl[i].Top, fielderhighlight: "null"));
            }
        }
        ...
        private void Swap_Click(object sender, EventArgs e)
        {
               ...
               FieldLoggerConstants.Field_Formation2_File))
            {
                ...
                using (StreamReader r = new StreamReader(FieldLoggerConstants.Cricket_Directory +
                    FieldLoggerConstants.Field_Directory + FieldLoggerConstants.Field_Formation2_File))
                {
