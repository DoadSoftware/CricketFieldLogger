...
{
    public partial class Page2Frm : Form
    {
...
*/
        ...
        private void Swap_Click(object sender, EventArgs e)
        {
            if (File.Exists(FieldLoggerConstants.Cricket_Directory +
               FieldLoggerConstants.Field_Formation2_File))
            {
                ...
                File.WriteAllText(FieldLoggerConstants.Cricket_Directory  +
                    FieldLoggerConstants.Field_Formation2_File, JsonConvert.SerializeObject(fieldersData));
                ...
                if (fieldersData != null)
                {
                    for (int i = 0; i < FieldLoggerConstants.Number_Of_Fielders; i++)
                    {
                        ...
                        File.WriteAllText(FieldLoggerConstants.Cricket_Directory + 
                            FieldLoggerConstants.Field_Formation2_File, updatedJsonData);
                    }
                }
            }
        }
        ...
        private void checkbox2_btn_Click(object sender, EventArgs e)
        {
            ...
            FieldersData existingData = JsonConvert.DeserializeObject<FieldersData>(
                File.ReadAllText(FieldLoggerConstants.Cricket_Directory + FieldLoggerConstants.Field_Formation2_File));
            ...
            File.WriteAllText(FieldLoggerConstants.Cricket_Directory + FieldLoggerConstants.Field_Formation2_File, JsonConvert.SerializeObject(existingData)
    );
            ...
            if (File.Exists(filePath))
            {
                ...
                if (lines.Length >= 2)
                {
                    ...
                    if (string.IsNullOrWhiteSpace(lines[0]) && string.IsNullOrWhiteSpace(lines[1]))
                    {
                        if (checkBox2.Checked)
                        {
                            lines[0] = "FielderFormation_2.JSON";
                            lines[1] = "true";
                        }
                        else
                        {
                ...
                else
                {
                    ...
                    newLines.Add("FielderFormation_2.JSON");
                    if (checkBox2.Checked)
                    {
                        newLines.Add("true");
                    }
            ...
            {            // Writing content to the text file
                using (StreamWriter outputFile = new StreamWriter(filePath))
                {
                    if (checkBox2.Checked)
                    {
                        outputFile.WriteLine("FielderFormation_2.JSON");
        ...
        private void FielderLbl_Click(object sender, EventArgs e, int id)
        {
            ...
            {
                FieldersData existingData = JsonConvert.DeserializeObject<FieldersData>(File.ReadAllText(FieldLoggerConstants.Cricket_Directory + FieldLoggerConstants.Field_Formation2_File));
        ...
        private void checkbox_btn_Click(object sender, EventArgs e)
        {
            if (File.Exists(FieldLoggerConstants.Cricket_Directory + FieldLoggerConstants.Field_Formation2_File))
            {
                string existingData = File.ReadAllText(FieldLoggerConstants.Cricket_Directory + FieldLoggerConstants.Field_Formation2_File);
                ...
                using (StreamWriter file = new StreamWriter(FieldLoggerConstants.Cricket_Directory + FieldLoggerConstants.Field_Formation2_File, false))
                {
