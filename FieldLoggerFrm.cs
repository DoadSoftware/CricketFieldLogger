...
;                fieldersData.Checkbox = true;
                File.WriteAllText(FieldLoggerConstants.Cricket_Directory + FieldLoggerConstants.Field_Directory + FieldLoggerConstants.Field_Formation_File,
        ...
        private void Swap_Click(object sender, EventArgs e)
        {
                ...
                FieldLoggerConstants.Field_Formation_File))
            {
                ...
                File.WriteAllText(FieldLoggerConstants.Cricket_Directory + FieldLoggerConstants.Field_Directory + 
                    FieldLoggerConstants.Field_Formation_File, JsonConvert.SerializeObject(fieldersData));
                ...
                using (StreamReader r = new StreamReader(FieldLoggerConstants.Cricket_Directory + 
                    FieldLoggerConstants.Field_Directory + FieldLoggerConstants.Field_Formation_File))
                {
