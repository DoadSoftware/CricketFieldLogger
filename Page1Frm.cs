       ...
       // public List<FieldersFormation> fieldersFormation;
        ...
        private void FielderLbl_Move(object sender, EventArgs e)
        {
            ...
            if (checkBox2.Checked)
            {
                ...
                File.WriteAllText(FieldLoggerConstants.Cricket_Directory + FieldLoggerConstants.Field_Directory + FieldLoggerConstants.Field_Formation1_File,
        ...
        private void Swap_Click(object sender, EventArgs e)
        {
                ...
                FieldLoggerConstants.Field_Formation1_File))
            {
                ...
                using (StreamReader r = new StreamReader(FieldLoggerConstants.Cricket_Directory +
                    FieldLoggerConstants.Field_Directory + FieldLoggerConstants.Field_Formation1_File))
                {
